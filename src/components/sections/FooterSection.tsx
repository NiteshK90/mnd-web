  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-6 md:gap-8 px-6 md:px-20">
        ...
        <p className={`font-inter text-base md:text-lg font-normal leading-[1.4] text-mnd-dark text-center opacity-60 ${animate("[transition-delay:900ms]")}`}>
      ...
      <div className="pt-2 md:pt-3 pb-4 md:pb-5 bg-[#090909] flex items-center justify-between px-6 md:px-[72px]">
        <button className="flex items-center h-8 md:h-10 px-4 md:px-8 rounded-full border-[1.5px] border-white/20 text-white/50 font-inter text-sm md:text-[18px] font-normal">
          Compliances
        </button>
