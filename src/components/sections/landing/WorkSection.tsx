...
const WorkSection = forwardRef<HTMLElement>((_, ref) => {
  return (
    <section
      ref={ref}
      className="min-h-screen md:h-screen w-full snap-start flex flex-col items-center justify-center gap-8 md:gap-20 px-6 md:px-0 text-center"
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 md:gap-12 pt-6 md:pt-10">
