...
const NoteSection2 = forwardRef<HTMLElement, NoteSection2Props>(({ onSkipToValues }, ref) => {
  return (
    <section ref={ref} className="h-screen w-full snap-start bg-transparent overflow-y-auto flex items-center">
      <div className="grid grid-cols-1 md:grid-cols-[400px_1fr] gap-x-0 md:gap-x-[120px] max-w-[1400px] mx-auto px-4 md:px-20 pt-28 md:pt-32 items-end">
        ...
        <div className="flex flex-col gap-4 md:gap-8 pb-8 md:pb-16">
          ...
          <p className="font-playfair text-[15px] md:text-[28px] font-semibold leading-[1.4] text-mnd-dark">
        ...
        <div className="flex flex-col gap-6 md:gap-8 mt-8 md:mt-0">
          <div className="flex flex-col gap-4 md:gap-6">
            <p className="font-inter text-[16px] font-normal leading-[1.6] text-mnd-dark max-w-[900px]">
            ...
            <p className="font-inter text-[16px] font-bold leading-[1.6] text-mnd-dark max-w-[900px]">
          ...
          <p className="font-inter text-[16px] font-normal leading-[1.6] text-mnd-dark">
