      ...
      <div className="grid grid-cols-1 md:grid-cols-[400px_1fr] gap-x-0 md:gap-x-[120px] max-w-[1400px] mx-auto pt-16 px-4 pb-10 md:pt-[180px] md:px-[80px] md:pb-[120px] items-end">
        ...
        <div className="flex flex-col gap-6 md:gap-8 mt-8 md:mt-0">
          <div className="flex flex-col gap-4 md:gap-6">
            <p className="font-sans text-[12px] md:text-[16px] font-medium leading-[1.3] text-mnd-dark max-w-[900px]">
            ...
            <p className="font-sans text-[12px] md:text-[16px] font-bold leading-[1.3] text-mnd-dark max-w-[900px]">
              We wanted to change that.
            </p>
            <p className="font-sans text-[12px] md:text-[16px] leading-[1.3] text-mnd-dark max-w-[900px]">
          ...
          <p className="font-sans text-[12px] md:text-[16px] font-medium leading-[1.3] text-mnd-dark">
