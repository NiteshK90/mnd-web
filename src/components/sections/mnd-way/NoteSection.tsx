...
const NoteSection = forwardRef<HTMLElement>((_, ref) => {
  return (
    <section ref={ref} className="h-screen w-full snap-start overflow-hidden">
      <div className="flex h-full overflow-x-auto snap-x snap-mandatory">

        {/* Slide 1 — yellow */}
        <div className="h-screen w-screen flex-shrink-0 snap-start bg-[#F9BC10] overflow-y-auto">
          <NoteContent />
        </div>

        {/* Slide 2 — transparent */}
        <div className="h-screen w-screen flex-shrink-0 snap-start bg-transparent overflow-y-auto">
          <NoteContent />
        </div>
