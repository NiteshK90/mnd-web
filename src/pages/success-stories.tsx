            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-x-6 sm:gap-x-8 gap-y-2 sm:gap-y-3 opacity-60">
                  <span className="text-base sm:text-lg font-semibold flex items-center gap-1.5">◁ Clari</span>
                  <span className="text-base sm:text-lg font-semibold flex items-center gap-1.5">➤ pendo</span>
                  <span className="text-base sm:text-lg font-semibold flex items-center gap-1.5">⊞ happay</span>
                  <span className="text-base sm:text-lg font-semibold italic">whatfix</span>
                  <span className="text-base sm:text-lg font-semibold flex items-center gap-1.5">◍ HealthPlix</span>
                </div>
              </div>
            </div>
          </div>
